...
const registerUser = asyncHandler(async (req, res) => {
    ...
    const user = await User.create({
        ...
        profileBackground: req.body.profileBackground ? req.body.profileBackground : "",
...
module.exports = { registerUser, loginUser, getMe, updateUserDetails, deleteUserDetails };
